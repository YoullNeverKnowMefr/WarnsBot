...
# лимит целевых ботов (неудалённых)
MAX_TARGETS = int(os.getenv("MAX_TARGETS", "100") or 100)
# лимит user-аккаунтов (.session)
MAX_ACCOUNTS = int(os.getenv("MAX_ACCOUNTS", "20") or 20)
